    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12">
        ...
        <div className="bg-white dark:bg-[#1A1010] border border-[#F2EDE8] dark:border-[#2A1A1A] rounded-xl p-5">
          ...
          <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mt-2">out of 5.0</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1010] border border-[#F2EDE8] dark:border-[#2A1A1A] rounded-xl p-5">
          ...
          <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mt-2">Rentals</p>
        </div>

        {/* Total bookings */}
        <div className="bg-white dark:bg-[#1A1010] border border-[#F2EDE8] dark:border-[#2A1A1A] rounded-xl p-5">
          <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mb-3">Total</p>
          <div className="text-4xl lg:text-5xl font-extrabold text-[#1A0A0A] dark:text-[#F5F0ED] leading-none">
            {myBookings.length}
          </div>
          <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mt-2">Bookings</p>
        </div>
        ...
        <div className={`rounded-xl p-5 ${
          ...
          <div className="flex items-center justify-between mb-3">
            <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85]">Identity</p>
          ...
          {profile?.kyc_status === 'approved' ? (
            <>
              ...
              <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mt-2">Verified</p>
            </>
          ) : (
            <>
              <div className="text-lg font-extrabold text-amber-700 dark:text-amber-400 leading-none mt-1">Unverified</div>
      ...
      <div className="mb-12">
        <div className="flex items-end justify-between mb-5">
          <div>
            <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mb-1">Your Bookings</p>
            <h2 className="text-lg font-extrabold uppercase text-[#1A0A0A] dark:text-[#F5F0ED] tracking-tight">Active &amp; Approved</h2>
          </div>
        ...
        <div className="bg-white dark:bg-[#1A1010] border border-[#F2EDE8] dark:border-[#2A1A1A] rounded-xl">
          {activeBookings.length === 0 ? (
            <div className="text-center py-16 px-8">
              ...
              <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mb-2">No active rentals yet</p>
              <p className="text-sm text-[#6B5B55] dark:text-[#9B8B85] mb-6">Browse items near you and make your first booking.</p>
      ...
      {/* Quick actions */}
      <div className="mb-12">
        <p className="text-[11px] font-medium uppercase tracking-[0.15em] text-[#9B8B85] mb-5">Quick Actions</p>
        <div className="grid grid-cols-3 gap-3">
          {[
            { href: '/listings', icon: Search, label: 'Browse', desc: 'Find items to rent' },
            { href: '/dashboard/renter/wishlist', icon: Heart, label: 'Wishlist', desc: 'Saved items' },
            { href: '/chat', icon: MessageCircle, label: 'Messages', desc: 'Chat with merchants' },
