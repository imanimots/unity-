  ...
  return (
    <LegalPageLayout doc={doc}>
      ...
      <LegalSection title="Privacy and POPIA requests">
        <p>To exercise a privacy right described in the <a href="/privacy" className="underline">Privacy Policy</a> or <a href="/popia" className="underline">POPIA Notice</a>, or to lodge a complaint: <strong>privacy@unitytest.co.za</strong></p>
      </LegalSection>
