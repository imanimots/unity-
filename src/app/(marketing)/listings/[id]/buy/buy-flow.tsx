...
export function BuyFlow({ listing }: { listing: Listing & { sale_price: number } }) {
  ...
  return (
    <div className="max-w-lg mx-auto px-4 sm:px-6 py-10">
      ...
      <h1 className="text-2xl font-extrabold uppercase text-[#1A0A0A] dark:text-[#F5F0ED] mb-6">Buy Now</h1>
      ...
      <div className="bg-white dark:bg-[#1A1010] rounded-xl border border-[#F2EDE8] dark:border-[#2A1A1A] p-5 mb-5">
        <div className="flex gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-[#6B5B55] dark:text-[#9B8B85] mt-1">R{listing.sale_price} each</p>
            <p className="text-xs text-[#9B8B85] mt-0.5">{listing.quantity_available} available</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#1A1010] rounded-xl border border-[#F2EDE8] dark:border-[#2A1A1A] p-5 mb-5 space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-sm font-medium text-[#1A0A0A] dark:text-[#F5F0ED]">Quantity</span>
        ...
        <div className="flex justify-between text-base pt-3 border-t border-[#F2EDE8] dark:border-[#2A1A1A]">
          ...
          <span className="font-bold text-[#1A0A0A] dark:text-[#F5F0ED]">R{total}</span>
        </div>
      </div>
