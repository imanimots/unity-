...
export const metadata: Metadata = {
  ...
  description: "South Africa's peer-to-peer rental marketplace. Verified users, escrow-protected payments, and thousands of items to rent near you.",
  keywords: ['rental', 'peer to peer', 'South Africa', 'rent', 'earn', 'marketplace'],
  openGraph: {
    title: 'Unity — Rent What You Need.',
    description: "South Africa's verified P2P rental marketplace.",
    type: 'website',
  },
}
