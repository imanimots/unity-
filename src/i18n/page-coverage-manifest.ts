...
export const PAGE_COVERAGE_MANIFEST: PageCoverageEntry[] = [
  ...
  { path: '(dashboard)/dashboard/orders/[id]/review/page.tsx', status: 'wired' },
  { path: '(dashboard)/dashboard/orders/page.tsx', status: 'wired' },
  { path: '(dashboard)/dashboard/merchant/orders/[id]/review/page.tsx', status: 'wired' },
  { path: '(dashboard)/dashboard/rent-to-buy/[id]/page.tsx', status: 'wired' },
  { path: '(dashboard)/dashboard/rent-to-buy/[id]/review/page.tsx', status: 'wired' },
