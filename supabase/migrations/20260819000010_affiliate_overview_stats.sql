-- ============================================================
-- Step 11 Phase 7 -- affiliate counts in get_admin_overview_stats()
-- ============================================================
-- Straight CREATE OR REPLACE of the proven function, byte-identical
-- except for 5 new keys appended to the jsonb_build_object call, same
-- pattern as every prior phase's own overview-stats migration.
